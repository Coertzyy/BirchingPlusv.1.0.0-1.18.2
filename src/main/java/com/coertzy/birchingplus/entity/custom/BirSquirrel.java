...
public class BirSquirrel extends Animal implements IAnimatable {
    private static final Ingredient DIET_SQUI = Ingredient.of(Items.POPPY, Items.SWEET_BERRIES,
            Items.WHEAT_SEEDS, BirItems.BIR_HAZELNUT.get());

    private AnimationFactory factory = new AnimationFactory(this);
    public BirSquirrel(EntityType<? extends Animal> p_27557_, Level p_27558_) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.25D, DIET_SQUI, false));
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob mob) {
        return EntityTypesBP.BIR_SQUIRREL.get().create(serverLevel);
    }

    @Override
    public boolean isFood(ItemStack p_29508_) {
        return DIET_SQUI.test(p_29508_);
    }
